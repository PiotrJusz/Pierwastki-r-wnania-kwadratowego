...
public class MainActivity extends AppCompatActivity {
    ...
    public String[] countDelta(Float a, Float b, Float c){
        ...
        String langInfo = Locale.getDefault().getLanguage();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextNumberDecimal_A = findViewById(R.id.editTextNumberDecimal_A);
        defaultTextColor = editTextNumberDecimal_A.getCurrentTextColor();
        editTextNumberDecimal_B = findViewById(R.id.editTextNumberDecimal_B);
        editTextNumberDecimal_C = findViewById(R.id.editTextNumberDecimal_C);
        textView_function = findViewById(R.id.textView_function);
        textView_delta = findViewById(R.id.textView_delta);
